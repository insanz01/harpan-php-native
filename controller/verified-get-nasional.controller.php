...
$query = "SELECT harga_nasional.id, harga_nasional.harga, komoditas.satuan, komoditas.id as id_komoditas, komoditas.nama as komoditas, harga_nasional.created_at, harga_nasional.approved_at, harga_nasional.updated_at FROM harga_nasional JOIN komoditas ON harga_nasional.id_komoditas = komoditas.id WHERE harga_nasional.deleted_at is NULL AND harga_nasional.approved_at is not NULL ORDER BY harga_nasional.created_at DESC";
